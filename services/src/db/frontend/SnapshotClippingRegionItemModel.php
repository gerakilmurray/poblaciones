...
class SnapshotClippingRegionItemModel extends BaseModel
{
	...
	private function GetSelectionInfoByZone($envelope, $levelId, $urbanity, $circle = null)
	{
		...
		if ($ret !== null)
		{
			$sqlMetadata = "SELECT met_id, met_title, met_abstract, met_publication_date, met_license, met_authors, ins_caption, ins_watermark_id " .
							"FROM geography ".
	...
	public function CalculateLevelsFromRegionId($regionItemId, $trackingLevels = false)
	{
		...
		if ($trackingLevels)
		{
          ...
          C1.geo_partial_coverage, metadata.*, ins_caption, ins_watermark_id
          FROM geography C1
